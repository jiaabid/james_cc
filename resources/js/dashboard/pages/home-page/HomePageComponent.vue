      ...
      <div class="page-inn">
        <div class="row">
          <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
            <div class="card" @click="openSlide(1)">
              ...
              <div class="card-footer p-3">
                <p class="mb-0">
                  <span class="text-success text-sm font-weight-bolder"
                    >{{ property.percentage_growth }}% </span
                  ><span
                    style="
                    ...
                    "
                  ></span
                  >{{ property.current_week_properties }} Per Week
                </p>
              </div>
            </div>
          </div>
          <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
            <div class="card" @click="openSlide(2)">
              <div class="card-header p-3 pt-2">
                <div
                  class="
                    icon icon-lg icon-shape
                ...
                <div class="text-end pt-1">
                  ...
                  <h4 class="mb-0">{{ user.total_users }}</h4>
                </div>
              </div>
              <hr class="dark horizontal my-0" />
              <div class="card-footer p-3">
                <p class="mb-0">
                  ...
                  ><span
                    ...
                    "
                  ></span
                  >{{ user.current_week_users }} Per Week
                </p>
              </div>
            </div>
          </div>
          <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
            <div class="card" @click="openSlide(3)">
              <div class="card-header p-3 pt-2">
                <div
                  class="
                    icon icon-lg icon-shape
                ...
                <div class="text-end pt-1">
                  ...
                  <h4 class="mb-0">{{ buildings.total_buildings }}</h4>
                </div>
              </div>
              <hr class="dark horizontal my-0" />
              <div class="card-footer p-3">
                <p class="mb-0">
                  <span class="text-danger text-sm font-weight-bolder"
                    >{{ buildings.percentage_growth }}%</span
                  ><span
                    style="
                      border-left: 1px solid gray;
                      height: 100px !important;
                    ...
                    "
                  ></span>
                  {{ buildings.current_week_buildings }} Per Week
                </p>
              </div>
            </div>
          </div>
          <div class="col-xl-3 col-sm-6">
            <div class="card" @click="openSlide(4)">
              <div class="card-header p-3 pt-2">
                <div
                  class="
                    icon icon-lg icon-shape
                ...
                <div class="text-end pt-1">
                  <p class="text-sm mb-0 text-capitalize">Meters</p>
                  <h4 class="mb-0">{{ meters.total_Meters }}</h4>
                </div>
              </div>
              <hr class="dark horizontal my-0" />
              <div class="card-footer p-3">
                <p class="mb-0">
                  ...
                  <span
                    ...
                    "
                  ></span>
                  {{ meters.current_week_Meters }} Per Week
                </p>
              </div>
            </div>
          </div>
        ...
        <div class="col-md-3">
          <div>
            <div class="chart-inner">
              <canvas id="BA-chart-job-error" width="300" height="230"></canvas>
            </div>
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    openSlide(num) {
      this.step = num;
      this.emitEvent("openSlide", num);
    },

    async initialize() {
      const res = await this.network().getDashboardCards();
      this.property = res.property;
      this.meters = res.meter;
      this.user = res.user;
